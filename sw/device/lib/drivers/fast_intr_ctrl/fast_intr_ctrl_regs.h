...
#define FAST_INTR_CTRL_FAST_INTR_PENDING_FAST_INTR_PENDING_FIELD                                                       \
  ((bitfield_field32_t){.mask = FAST_INTR_CTRL_FAST_INTR_PENDING_FAST_INTR_PENDING_MASK,                               \
                        .index = FAST_INTR_CTRL_FAST_INTR_PENDING_FAST_INTR_PENDING_OFFSET})
...
#define FAST_INTR_CTRL_FAST_INTR_CLEAR_FAST_INTR_CLEAR_FIELD                                                           \
  ((bitfield_field32_t){.mask = FAST_INTR_CTRL_FAST_INTR_CLEAR_FAST_INTR_CLEAR_MASK,                                   \
                        .index = FAST_INTR_CTRL_FAST_INTR_CLEAR_FAST_INTR_CLEAR_OFFSET})

// Enable fast interrupt
#define FAST_INTR_CTRL_FAST_INTR_ENABLE_REG_OFFSET 0x8
#define FAST_INTR_CTRL_FAST_INTR_ENABLE_FAST_INTR_ENABLE_MASK 0xffff
...
#define FAST_INTR_CTRL_FAST_INTR_ENABLE_FAST_INTR_ENABLE_FIELD                                                         \
  ((bitfield_field32_t){.mask = FAST_INTR_CTRL_FAST_INTR_ENABLE_FAST_INTR_ENABLE_MASK,                                 \
                        .index = FAST_INTR_CTRL_FAST_INTR_ENABLE_FAST_INTR_ENABLE_OFFSET})
