...
#define DEBUG_MODULE_START_ADDRESS 0x00010000
#define DEBUG_MODULE_SIZE 0x00010000
#define DEBUG_MODULE_END_ADDRESS (DEBUG_MODULE_START_ADDRESS + DEBUG_MODULE_SIZE)

#define PERIPHERALS_START_ADDRESS 0x00020000
#define PERIPHERALS_SIZE 0x10000000
#define PERIPHERALS_END_ADDRESS (PERIPHERALS_START_ADDRESS + PERIPHERALS_SIZE)

#define EXT_SLAVE_START_ADDRESS 0x10020000
#define EXT_SLAVE_SIZE 0x00010000
#define EXT_SLAVE_END_ADDRESS (EXT_SLAVE_START_ADDRESS + EXT_SLAVE_SIZE)

#define SOC_CTRL_BASE_ADDRESS PERIPHERALS_START_ADDRESS + 0x00000000
#define SOC_CTRL_SIZE 0x00001000
#define SOC_CTRL_END_ADDRESS (SOC_CTRL_BASE_ADDRESS + SOC_CTRL_SIZE)

#define BOOTROM_BASE_ADDRESS PERIPHERALS_START_ADDRESS + 0x00010000
#define BOOTROM_SIZE 0x00010000
#define BOOTROM_END_ADDRESS (BOOTROM_BASE_ADDRESS + BOOTROM_SIZE)

#define FAST_INTR_CTRL_BASE_ADDRESS PERIPHERALS_START_ADDRESS + 0x00020000
#define FAST_INTR_CTRL_SIZE 0x00001000
#define FAST_INTR_CTRL_END_ADDRESS (FAST_INTR_CTRL_BASE_ADDRESS + FAST_INTR_CTRL_SIZE)

#define UART_BASE_ADDRESS PERIPHERALS_START_ADDRESS + 0x10000000
#define UART_SIZE 0x00001000
#define UART_END_ADDRESS (UART_BASE_ADDRESS + UART_SIZE)

#define EXT_PERIPHERAL_BASE_ADDRESS PERIPHERALS_START_ADDRESS + 0x11000000
#define EXT_PERIPHERAL_SIZE 0x00001000
