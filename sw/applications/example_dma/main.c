...
// printf halts at the moment, so they are disabled - matteo
...
// ORIGINAL DEFINITION FROM XHEEP that uses interrupts
// #define WAIT_DMA                              \
...
// changed return val since printf is unusable - matteo
...
//
    ...
    // trans.win_du = 0;
    // trans.sign_ext = 0;
    // trans.end = DMA_TRANS_END_POLLING; // CHANGED TO POLLING
