///////////////////////////////////////////////////////////////////////////////
//  File name : s25fs512s.v
///////////////////////////////////////////////////////////////////////////////
//  Copyright (C) 2012-2020 Free Model Foundry; http://www.FreeModelFoundry.com
//
...
//    V1.0      V.Mancev       25 Dec 12      Initial version
//                                            (FS-S_DRS_V3.1; Aug 10,2012)
//    V1.1      S.Petrovic     29 Nov 13      Corrected Quad DDR read
//                                            with DLP
//    V1.2      S.Petrovic     23 Dec 13      DLP read enabled with 4 latency
//                                            cycles
//    V1.3      S.Petrovic     10 Apr 14      Corrected assignment of PageSize
//                                            signal
//    V1.4      S.Petrovic     26 Aug 14      Corrected SFDP read. Added SFDP JEDEC
//                                            parameter
//    V1.5      S.Petrovic     16 Oct 14      Assignment of read_out is changed to
//                                            non-blocking. oe is gated with CS#
//    V1.6      M.Stojanovic   27 Apr 15      Corrected SFDP JEDEC parameters
//                                            Ignored upper address bits for READ4
//    V1.7      M.Stojanovic   13 May 15      Added DPD and RES_DPD commands
//
//    V1.8      S.Stevanovic   18 Feb 16      Per client request changing the
//                                            default value of TimingModel
//                                            parameter from DefaultTimingModel
//                                            to S25FS512SAGBHIY10_F_30pF
//
//    V1.9      M.Stojanovic   24 Mar 16      Corrected CFI parameter definition width
//
//    V1.10     B.Barac        14 May 19      Corrected WRAR command, it no longer write
//                                            SR1_V[7] (SRWD bit) with volotile address
//    V1.11     B.Barac        17 Jun 20      Wrap read and few other discrepencies fixed
///////////////////////////////////////////////////////////////////////////////
//  PART DESCRIPTION:
//
//  Library:    FLASH
...
///////////////////////////////////////////////////////////////////////////////
    ...
    parameter mem_file_name     = "none";//"s25fs512s.mem";
    parameter otp_file_name     = "s25fs512sOTP.mem";//"none";

    parameter TimingModel       = "S25FS512SAGBHIY10_F_30pF";

    parameter  PartID           = "s25fs512s";
    parameter  MaxData          = 255;
    parameter  MemSize          = 28'h3FFFFFF;
    parameter  SecSize256       = 20'h3FFFF;
    parameter  SecSize4         = 12'hFFF;
    parameter  SecNumUni        = 255;
    parameter  SecNumHyb        = 263;
    ...
    parameter  SFDPHiAddr       = 16'h1117;
    parameter  SFDPLength       = 16'h1117;
    parameter  CFILength        = 16'h117;
    parameter  BYTE             = 8;
...
//        `define SPEEDSIM;
    ...
    reg[SecNumHyb:0] PPB_bits  = {264{1'b1}};

    // DYB Access Register
    reg[7:0] DYBAR             = 8'hFF;
    reg[7:0] DYBAR_in          = 8'hFF;

    reg[SecNumHyb:0] DYB_bits  = {264{1'b1}};
    ...
    reg[SecNumHyb:0] ERS_nosucc  = {264{1'b0}};
    ...
    reg [SecNumHyb:0] Sec_Prot  = 264'b0;
...
specify
    ...
    `ifdef SPEEDSIM
        ...
        specparam        tdevice_BE                = 720e9;//tBE = 720ms
        ...
        specparam        tdevice_RES               = 30e6;     // 30 us
    `else
        // WRR Cycle Time
        ...
        // Bulk Erase Operation
        specparam        tdevice_BE                = 720e12;//tBE = 720s
        // Evaluate Erase Status Time
...
///////////////////////////////////////////////////////////////////////////////
    ...
    $hold  ( posedge SCK &&& ddro_quad_io0, SO ,     thold_SI_SCK_ddr    ,Viol);
    $hold  ( negedge SCK &&& ddro_quad_io0, SO ,     thold_SI_SCK_ddr    ,Viol);

    $hold  ( posedge SCK &&& sdro_quad_io2, WPNeg,   thold_SI_SCK_sdr    ,Viol);
    $hold  ( posedge SCK &&& ddro_quad_io2, WPNeg,   thold_SI_SCK_ddr    ,Viol);
    $hold  ( negedge SCK &&& ddro_quad_io2, WPNeg,   thold_SI_SCK_ddr    ,Viol);

    $hold  ( posedge SCK &&& sdro_quad_io3, RESETNeg,thold_SI_SCK_sdr    ,Viol);
    $hold  ( posedge SCK &&& ddro_quad_io3, RESETNeg,thold_SI_SCK_ddr    ,Viol);
    $hold  ( negedge SCK &&& ddro_quad_io3, RESETNeg,thold_SI_SCK_ddr    ,Viol);
...
//Bus cycle state
 ...
 reg [2:0] bus_cycle_state;
    ...
    begin: InitMemory
        ...
        begin
           // Memory Preload
           //s25fs512s.mem, memory preload file
    ...
    integer j;
        ...
        //assumptions:
        //1. TimingModel has format as S25FS512SXXXXXXXX_X_XXpF
    ...
    integer k,l,m;
        ...
        SFDP_array[16'h000C] = 8'h90;
        SFDP_array[16'h000D] = 8'h10;
        ...
        SFDP_array[16'h0014] = 8'h90;
        SFDP_array[16'h0015] = 8'h10;
        ...
        SFDP_array[16'h001C] = 8'h90;
        SFDP_array[16'h001D] = 8'h10;
        ...
        SFDP_array[16'h0023] = 8'h10;
        SFDP_array[16'h0024] = 8'hD8;
        SFDP_array[16'h0025] = 8'h10;
        ...
        SFDP_array[16'h002C] = 8'hD0;
        SFDP_array[16'h002D] = 8'h10;
        ...
        SFDP_array[16'h1008] = 8'hxx;
        SFDP_array[16'h1009] = 8'hxx;
        SFDP_array[16'h100A] = 8'hxx;
        SFDP_array[16'h100B] = 8'hxx;
        SFDP_array[16'h100C] = 8'hxx;
        SFDP_array[16'h100D] = 8'hxx;
        SFDP_array[16'h100E] = 8'hxx;
        SFDP_array[16'h100F] = 8'hxx;
        ...
        SFDP_array[16'h1034] = 8'h03;
        SFDP_array[16'h1035] = 8'hFE;
        SFDP_array[16'h1036] = 8'h00;
        SFDP_array[16'h1037] = 8'h00;
        SFDP_array[16'h1038] = 8'h04;
        ...
        SFDP_array[16'h1083] = 8'hF0;
        SFDP_array[16'h1084] = 8'h09;
        SFDP_array[16'h1085] = 8'hFF;
        SFDP_array[16'h1086] = 8'hFF;
        SFDP_array[16'h1087] = 8'hFF;
        ...
        SFDP_array[16'h108F] = 8'h88;
        SFDP_array[16'h1090] = 8'hE7;
        ...
        SFDP_array[16'h10B0] = 8'h12;
        SFDP_array[16'h10B1] = 8'hD8;
        SFDP_array[16'h10B2] = 8'h00;
        SFDP_array[16'h10B3] = 8'hFF;
        SFDP_array[16'h10B4] = 8'h82;
        SFDP_array[16'h10B5] = 8'h42;
        SFDP_array[16'h10B6] = 8'h11;
        SFDP_array[16'h10B7] = 8'hFF;
        SFDP_array[16'h10B8] = 8'h91;
        SFDP_array[16'h10B9] = 8'h26;
        SFDP_array[16'h10BA] = 8'h07;
        SFDP_array[16'h10BB] = 8'hE2;
        SFDP_array[16'h10BC] = 8'hEC;
        SFDP_array[16'h10BD] = 8'h83;
        SFDP_array[16'h10BE] = 8'h18;
        SFDP_array[16'h10BF] = 8'h44;
        SFDP_array[16'h10C0] = 8'h8A;
        SFDP_array[16'h10C1] = 8'h85;
        SFDP_array[16'h10C2] = 8'h7A;
        SFDP_array[16'h10C3] = 8'h75;
        SFDP_array[16'h10C4] = 8'hF7;
        SFDP_array[16'h10C5] = 8'hBD;
        SFDP_array[16'h10C6] = 8'hD5;
        SFDP_array[16'h10C7] = 8'h5C;
        SFDP_array[16'h10C8] = 8'h8C;
        SFDP_array[16'h10C9] = 8'hF6;
        SFDP_array[16'h10CA] = 8'h5D;
        SFDP_array[16'h10CB] = 8'hFF;
        SFDP_array[16'h10CC] = 8'hF0;
        SFDP_array[16'h10CD] = 8'h30;
        SFDP_array[16'h10CE] = 8'hF8;
        SFDP_array[16'h10CF] = 8'hA1;
        SFDP_array[16'h10D0] = 8'h6B;
        SFDP_array[16'h10D1] = 8'h8E;
        SFDP_array[16'h10D2] = 8'hFF;
        SFDP_array[16'h10D3] = 8'hFF;
        SFDP_array[16'h10D4] = 8'h21;
        SFDP_array[16'h10D5] = 8'hDC;
        SFDP_array[16'h10D6] = 8'hDC;
        SFDP_array[16'h10D7] = 8'hFF;
        SFDP_array[16'h10D8] = 8'hFC;
        SFDP_array[16'h10D9] = 8'h65;
        SFDP_array[16'h10DA] = 8'hFF;
        SFDP_array[16'h10DB] = 8'h08;
        SFDP_array[16'h10DC] = 8'h04;
        SFDP_array[16'h10DD] = 8'h00;
        SFDP_array[16'h10DE] = 8'h00;
        SFDP_array[16'h10DF] = 8'h00;
        SFDP_array[16'h10E0] = 8'hFC;
        SFDP_array[16'h10E1] = 8'h65;
        SFDP_array[16'h10E2] = 8'hFF;
        SFDP_array[16'h10E3] = 8'h04;
        SFDP_array[16'h10E4] = 8'h02;
        SFDP_array[16'h10E5] = 8'h00;
        SFDP_array[16'h10E6] = 8'h00;
        SFDP_array[16'h10E7] = 8'h00;
        SFDP_array[16'h10E8] = 8'hFD;
        SFDP_array[16'h10E9] = 8'h65;
        SFDP_array[16'h10EA] = 8'hFF;
        SFDP_array[16'h10EB] = 8'h02;
        SFDP_array[16'h10EC] = 8'h04;
        SFDP_array[16'h10ED] = 8'h00;
        SFDP_array[16'h10EE] = 8'h00;
        SFDP_array[16'h10EF] = 8'h00;
        SFDP_array[16'h10F0] = 8'hFE;
        SFDP_array[16'h10F1] = 8'h01;
        SFDP_array[16'h10F2] = 8'h02;
        SFDP_array[16'h10F3] = 8'hFF;
        SFDP_array[16'h10F4] = 8'hF1;
        SFDP_array[16'h10F5] = 8'h7F;
        SFDP_array[16'h10F6] = 8'h00;
        SFDP_array[16'h10F7] = 8'h00;
        SFDP_array[16'h10F8] = 8'hF4;
        SFDP_array[16'h10F9] = 8'h7F;
        SFDP_array[16'h10FA] = 8'h03;
        SFDP_array[16'h10FB] = 8'h00;
        SFDP_array[16'h10FC] = 8'hF4;
        SFDP_array[16'h10FD] = 8'hFF;
        SFDP_array[16'h10FE] = 8'hFB;
        SFDP_array[16'h10FF] = 8'h03;
        SFDP_array[16'h1100] = 8'hFE;
        SFDP_array[16'h1101] = 8'h03;
        SFDP_array[16'h1102] = 8'h02;
        SFDP_array[16'h1103] = 8'hFF;
        SFDP_array[16'h1104] = 8'hF4;
        SFDP_array[16'h1105] = 8'hFF;
        SFDP_array[16'h1106] = 8'hFB;
        SFDP_array[16'h1107] = 8'h03;
        SFDP_array[16'h1108] = 8'hF4;
        SFDP_array[16'h1109] = 8'h7F;
        SFDP_array[16'h110A] = 8'h03;
        SFDP_array[16'h110B] = 8'h00;
        SFDP_array[16'h110C] = 8'hF1;
        SFDP_array[16'h110D] = 8'h7F;
        SFDP_array[16'h110E] = 8'h00;
        SFDP_array[16'h110F] = 8'h00;
        SFDP_array[16'h1110] = 8'hFF;
        SFDP_array[16'h1111] = 8'h05;
        SFDP_array[16'h1112] = 8'h00;
        SFDP_array[16'h1113] = 8'hFF;
        SFDP_array[16'h1114] = 8'hF4;
        SFDP_array[16'h1115] = 8'hFF;
        SFDP_array[16'h1116] = 8'hFF;
        SFDP_array[16'h1117] = 8'h03;
                ...
                begin
                    ...
                    begin
                        ...
                        begin
                            ...
                            if (UniformSec || (TopBoot && (sect < 255)) ||
                               (BottomBoot && sect > 8))
                            begin
                                if (Sec_Prot[sect]== 0 && PPB_bits[sect]== 1
                                     && DYB_bits[sect]== 1)
                            ...
                            else if ((TopBoot && sect >= 255) ||
                                    (BottomBoot && sect <= 8))
                            begin
                                if (Sec_ProtSE == 9 && ASP_ProtSE == 9)
                        ...
                        begin
                            ReturnSectorID(sect,Address);
                            if (UniformSec || (TopBoot && sect < 256) ||
                               (BottomBoot && sect > 7))
                            begin
...
//    /////////////////////////////////////////////////////////////////////////
    ...
    always @(rising_edge_PoweredUp or posedge oe or posedge oe_z or
           ...
           rising_edge_EESDONE or falling_edge_write or rising_edge_DPD_out or rising_edge_RES_out)
    begin: Functionality
    integer i,j;
    integer sect;
...
//                         SR1_V [7] = WRAR_reg_in[7];
        ...
        if (falling_edge_write)
        begin
            if (Instruct == RSTEN && current_state != DP_DOWN)
                RESET_EN <= 1;
            else
                RESET_EN <= 0;
        end
            ...
            begin
                ...
                begin
                    ...
                    begin
                        if (~TBPROT_O)  // BP starts at Top
                        begin
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)*63/64]= {12{1'b1}};
                            Sec_Prot[(SecNumHyb-7)*63/64-1 : 0]   = {252{1'b0}};
                        end
                        else
                        begin
                            Sec_Prot[(SecNumHyb-7)/64-1 : 0]      =   {4{1'b1}};
                            Sec_Prot[SecNumHyb :(SecNumHyb-7)/64] = {260{1'b0}};
                        end
                    end
                    ...
                    begin
                        ...
                        begin
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)*63/64+8] =
                                                                      {4{1'b1}};
                            Sec_Prot[(SecNumHyb-7)*63/64+7 : 0]   = {260{1'b0}};
                        end
                        else            // BP starts at Bottom
                        begin
                            Sec_Prot[(SecNumHyb-7)/64+7 : 0]      =  {12{1'b1}};
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/64+8]= {252{1'b0}};
                        end
                    end
                end
            end
            ...
            begin
                ...
                begin
                    ...
                    begin
                        if (~TBPROT_O)  // BP starts at Top
                        begin
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)*31/32]= {16{1'b1}};
                            Sec_Prot[(SecNumHyb-7)*31/32-1 : 0]   = {248{1'b0}};
                        end
                        else
                        begin
                            Sec_Prot[(SecNumHyb-7)/32-1 : 0]      =   {8{1'b1}};
                            Sec_Prot[SecNumHyb :(SecNumHyb-7)/32] = {256{1'b0}};
                        end
                    end
                    else          // 4 KB Physical Sectors at Bottom
                    begin
                        ...
                        begin
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)*31/32+8] =
                                                                      {8{1'b1}};
                            Sec_Prot[(SecNumHyb-7)*31/32+7 : 0]   = {256{1'b0}};
                        end
                        else            // BP starts at Bottom
                        begin
                            Sec_Prot[(SecNumHyb-7)/32+7 : 0]      =  {16{1'b1}};
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/32+8]= {248{1'b0}};
                        end
                    end
                end
            end
            ...
            begin
                ...
                begin
                    ...
                    begin
                        if (~TBPROT_O)  // BP starts at Top
                        begin
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)*15/16]= {24{1'b1}};
                            Sec_Prot[(SecNumHyb-7)*15/16-1 : 0]   = {240{1'b0}};
                        end
                        else
                        begin
                            Sec_Prot[(SecNumHyb-7)/16-1 : 0]      =  {16{1'b1}};
                            Sec_Prot[SecNumHyb :(SecNumHyb-7)/16] = {248{1'b0}};
                        end
                    end
                    else          // 4 KB Physical Sectors at Bottom
                    begin
                        ...
                        begin
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)*15/16+8] =
                                                                     {16{1'b1}};
                            Sec_Prot[(SecNumHyb-7)*15/16+7 : 0]   = {248{1'b0}};
                        end
                        else            // BP starts at Bottom
                        begin
                            Sec_Prot[(SecNumHyb-7)/16+7 : 0]      =  {24{1'b1}};
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/16+8]= {240{1'b0}};
                        end
                    end
                end
            end
            ...
            begin
                ...
                begin
                    ...
                    begin
                        if (~TBPROT_O)  // BP starts at Top
                        begin
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)*7/8]= {40{1'b1}};
                            Sec_Prot[(SecNumHyb-7)*7/8-1 : 0]   = {224{1'b0}};
                        end
                        else
                        begin
                            Sec_Prot[(SecNumHyb-7)/8-1 : 0]      =  {32{1'b1}};
                            Sec_Prot[SecNumHyb :(SecNumHyb-7)/8] = {232{1'b0}};
                        end
                    end
                    else          // 4 KB Physical Sectors at Bottom
                    begin
                        ...
                        begin
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)*7/8+8] =
                                                                     {32{1'b1}};
                            Sec_Prot[(SecNumHyb-7)*7/8+7 : 0]     = {232{1'b0}};
                        end
                        else            // BP starts at Bottom
                        begin
                            Sec_Prot[(SecNumHyb-7)/8+7 : 0]       =  {40{1'b1}};
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/8+8] = {224{1'b0}};
                        end
                    end
                end
            end
            ...
            begin
                ...
                begin
                    ...
                    begin
                        if (~TBPROT_O)  // BP starts at Top
                        begin
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)*3/4]= {72{1'b1}};
                            Sec_Prot[(SecNumHyb-7)*3/4-1 : 0]   = {192{1'b0}};
                        end
                        else
                        begin
                            Sec_Prot[(SecNumHyb-7)/4-1 : 0]      =  {64{1'b1}};
                            Sec_Prot[SecNumHyb :(SecNumHyb-7)/4] = {200{1'b0}};
                        end
                    end
                    else          // 4 KB Physical Sectors at Bottom
                    begin
                        ...
                        begin
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)*3/4+8] =
                                                                     {64{1'b1}};
                            Sec_Prot[(SecNumHyb-7)*3/4+7 : 0]     = {200{1'b0}};
                        end
                        else            // BP starts at Bottom
                        begin
                            Sec_Prot[(SecNumHyb-7)/4+7 : 0]       =  {72{1'b1}};
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/4+8] = {192{1'b0}};
                        end
                    end
                end
            end
            ...
            begin
                ...
                begin
                    ...
                    begin
                        if (~TBPROT_O)  // BP starts at Top
                        begin
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/2] = {136{1'b1}};
                            Sec_Prot[(SecNumHyb-7)/2-1 : 0]     = {128{1'b0}};
                        end
                        else
                        begin
                            Sec_Prot[(SecNumHyb-7)/2-1 : 0]      = {128{1'b1}};
                            Sec_Prot[SecNumHyb :(SecNumHyb-7)/2] = {136{1'b0}};
                        end
                    end
                    else          // 4 KB Physical Sectors at Bottom
                    begin
                        if (~TBPROT_O)  // BP starts at Top
                        begin
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/2+8] = {128{1'b1}};
                            Sec_Prot[(SecNumHyb-7)/2+7 : 0]       = {136{1'b0}};
                        end
                        else            // BP starts at Bottom
                        begin
                            Sec_Prot[(SecNumHyb-7)/2+7 : 0]       = {136{1'b1}};
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/2+8] = {128{1'b0}};
                        end
                    end
                end
            end
