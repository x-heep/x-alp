...
module pad_ring (
    ...
    % if attribute_bits != None:
        input logic [core_v_mcu_pkg::NUM_PAD-1:0][${attribute_bits}] pad_attributes_i
    % else:
...
% for pad in xheep.get_padring().pad_list:
    ...
    pad_io = pin0_name + "io"
    pad_attributes_i = f"pad_attributes_i[core_v_mcu_pkg::PAD_{pad.name.upper()}]" if attribute_bits != None else "\'0"
