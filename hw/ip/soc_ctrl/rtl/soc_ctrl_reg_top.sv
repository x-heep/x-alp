...
module soc_ctrl_reg_top #(
    ...
    always_comb begin
        ...
        addr_hit[5] = (reg_addr == SOC_CTRL_SYSTEM_FREQUENCY_HZ_OFFSET);
    end
    ...
    assign system_frequency_hz_we = addr_hit[5] & reg_we & !reg_error;
    ...
    always_comb begin
        ...
        unique case (1'b1)
            ...
            addr_hit[2]: begin
                reg_rdata_next[1:0] = boot_select_qs;
            end
