...
module bus_subsystem (
    ...
    axi_to_reg_v2 #(
        ...
        .clk_i    (clk_i),
        .rst_ni   (rst_ni),
        .axi_req_i(axi_slave_req[PERIPHERAL_DOMAIN_S_BUS_IDX]),
        .axi_rsp_o(axi_slave_rsp[PERIPHERAL_DOMAIN_S_BUS_IDX]),
    ...
    for (genvar i = 0; i < totalAxiSlaves; i++) begin : gen_axislave_rsp_assign
        if (i != PERIPHERAL_DOMAIN_S_BUS_IDX) begin : gen_axislave_rsp_assign_nonperiph
