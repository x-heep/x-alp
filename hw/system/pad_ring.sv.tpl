...
<%!
    from XheepGen.pads.pin import Input, Output, Inout, PinDigital, Asignal
%>
...
<%
    ...
    analog_signal_pads = [ pad for pad in xalp.get_padring().pad_list if any(isinstance(pin, Asignal) for pin in pad.pins) ]
%>
