...
set_property IOSTANDARD LVCMOS33 [get_ports {uart_tx_o uart_rx_i jtag_tdi_i jtag_tms_i jtag_tck_i jtag_tdo_o jtag_trst_ni}]
# set_property IOSTANDARD LVCMOS33 [get_ports {i2c_sda_io i2c_scl_io}]
