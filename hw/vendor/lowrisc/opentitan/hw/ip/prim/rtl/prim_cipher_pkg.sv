...
package prim_cipher_pkg;
    ...
    parameter logic [15:0][3:0] PRINCE_SBOX4 = {
        4'h4,
        4'hD,
        4'h5,
        4'hE,
    ...
    parameter logic [15:0][3:0] PRINCE_SBOX4_INV = {
        4'h1,
        4'hC,
        4'hE,
        4'h5,
    ...
    // nibble permutations
    parameter logic [15:0][3:0] PRINCE_SHIFT_ROWS64 = '{
        4'hF,
        4'hA,
        4'h5,
        4'h0,
    ...
    parameter logic [15:0][3:0] PRINCE_SHIFT_ROWS64_INV = '{
        4'hF,
        4'h2,
        4'h5,
        4'h8,
    ...
    parameter logic [11:0][63:0] PRINCE_ROUND_CONST = {
    ...
    parameter logic [15:0][3:0] PRESENT_SBOX4 = {
        4'h2,
        4'h1,
        4'h7,
        4'h4,
    ...
    parameter logic [15:0][3:0] PRESENT_SBOX4_INV = {
        4'hA,
        4'h9,
        4'h7,
        4'h0,
    ...
    parameter logic [31:0][4:0] PRESENT_PERM32 = {
        5'd31,
        5'd23,
        5'd15,
        5'd07,
    ...
    parameter logic [31:0][4:0] PRESENT_PERM32_INV = {
        5'd31,
        5'd27,
        5'd23,
        5'd19,
    ...
    parameter logic [63:0][5:0] PRESENT_PERM64 = {
        6'd63,
        6'd47,
        6'd31,
        6'd15,
    ...
    parameter logic [63:0][5:0] PRESENT_PERM64_INV = {
        6'd63,
        6'd59,
        6'd55,
        6'd51,
