...
package spi_device_pkg;
    ...
    typedef enum spi_byte_t {
        ...
        CmdWriteStatus1 = 8'h01,
        CmdWriteStatus2 = 8'h31,
        CmdWriteStatus3 = 8'h11,

        CmdReadStatus1 = 8'h05,
        CmdReadStatus2 = 8'h35,
        CmdReadStatus3 = 8'h15,

        CmdJedecId = 8'h9F,

        CmdPageProgram     = 8'h02,
        CmdQuadPageProgram = 8'h32,  // Not supported

        CmdSectorErase  = 8'h20,  // 4kB erase
        CmdBlockErase32 = 8'h52,  // 32kB
        CmdBlockErase64 = 8'hD8,  // 64kB

        CmdReadData   = 8'h03,
        CmdReadFast   = 8'h0B,  // with Dummy
        CmdReadDual   = 8'h3B,
        CmdReadQuad   = 8'h6B,
        CmdReadDualIO = 8'hBB,
        CmdReadQuadIO = 8'hEB,

        CmdWriteDisable = 8'h04,
        CmdWriteEnable  = 8'h06,

        CmdReadSfdp = 8'h5A,

        CmdEnableReset = 8'h66,
        CmdResetDevice = 8'h99
    } spi_cmd_e;
    ...
    typedef struct packed {logic [SramDw-1:0] data;} sram_data_t;
    typedef struct packed {
        logic uncorr;
        logic corr;
    } sram_err_t;
