...
module pad_ring (
            ...
            inout wire ddr_rcv_clk_io,

            input logic ddr_snd_clk_i,
            inout wire ddr_snd_clk_io,
    ...
    pad_cell_input #(
        ...
        .pad_in_i(1'b0),
        .pad_oe_i(1'b0),
        .pad_out_o(ddr_rcv_clk_o),
        .pad_io(ddr_rcv_clk_io),
        .pad_attributes_i('0)
    );
    ...
    pad_cell_output #(
        ...
        .pad_in_i(ddr_snd_clk_i),
        .pad_oe_i(1'b1),
        .pad_out_o(),
        .pad_io(ddr_snd_clk_io),
        .pad_attributes_i('0)
    );
