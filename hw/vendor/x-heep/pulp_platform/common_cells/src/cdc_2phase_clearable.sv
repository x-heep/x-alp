...
<<<<<<< HEAD:hw/vendor/pulp_platform/commoncells/src/cdc_2phase_clearable.sv
...
=======
  ...
  input  logic src_valid_i,
  output logic src_ready_o,
>>>>>>> origin/main:hw/vendor/x-heep/pulp_platform/common_cells/src/cdc_2phase_clearable.sv
    ...
    if (CLEAR_ON_ASYNC_RESET) begin : gen_elaboration_assertion
        ...
        if (SYNC_STAGES < 2) begin : gen_elaboration_assertion
            $error(
                "A minimum of 2 synchronizer stages is required for proper functionality."
            );
        end
    end
