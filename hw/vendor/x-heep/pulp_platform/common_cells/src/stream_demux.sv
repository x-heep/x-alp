...
module stream_demux #(
<<<<<<< HEAD:hw/vendor/pulp_platform/commoncells/src/stream_demux.sv
...
=======
  ...
  parameter int unsigned N_OUP     = 32'd1,
  /// Dependent parameters, DO NOT OVERRIDE!
  parameter int unsigned LOG_N_OUP = (N_OUP > 32'd1) ? unsigned'($clog2(N_OUP)) : 32'd1
>>>>>>> origin/main:hw/vendor/x-heep/pulp_platform/common_cells/src/stream_demux.sv
) (
