...
module passthrough_stream_fifo #(
    ...
    always_comb begin
        ...
        if (flush_i) begin  // Flush
            ...
            if (ready_i) begin
<<<<<<< HEAD:hw/vendor/pulp_platform/commoncells/src/passthrough_stream_fifo.sv
                if (read_ptr_q[PointerWidth-2:0] == (Depth - 1)) begin
=======
                if (read_ptr_q[PointerWidth-2:0] == (PointerWidth-1)'(Depth-1)) begin
>>>>>>> origin/main:hw/vendor/x-heep/pulp_platform/common_cells/src/passthrough_stream_fifo.sv
