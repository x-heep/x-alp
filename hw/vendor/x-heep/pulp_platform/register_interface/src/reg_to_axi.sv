...
module reg_to_axi #(
    ...
    `FFLARNC(ar_pnd_q, axi_rsp_i.ar_ready, axi_req_o.ar_valid, axi_rsp_i.r_valid, 1'b0, clk_i,
             rst_ni)
    `FFLARNC(aw_pnd_q, axi_rsp_i.aw_ready, axi_req_o.aw_valid, axi_rsp_i.b_valid, 1'b0, clk_i,
             rst_ni)
