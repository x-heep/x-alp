...
module axi_atop_filter #(
    ...
    localparam int unsigned COUNTER_WIDTH = (AxiMaxWriteTxns == 1) ? 2 : $clog2(
        AxiMaxWriteTxns + 1
    );
...
<<<<<<< HEAD:hw/vendor/pulp_platform/axi/src/axi_atop_filter.sv
            W_FEEDTHROUGH: begin
...
=======
      W_FEEDTHROUGH: begin
        ...
        if (aw_without_complete_w_downstream // .. downstream is missing W bursts ..
            ...
            // downstream (to prevent underflows of w_cnt).
            || ((slv_req_i.aw_valid && slv_req_i.aw.atop[5:4] == axi_pkg::ATOP_NONE)
>>>>>>> origin/main:hw/vendor/x-heep/pulp_platform/axi/src/axi_atop_filter.sv
                && !complete_w_without_aw_downstream)
        ) begin
