        ...
        if (r_cnt_q > '0) begin
            ...
            rd_meta_d = '{
                ...
                axi_pkg::aligned_addr(
                    axi_pkg::largest_addr_t'(axi_req_i.ar.addr), axi_req_i.ar.size
                )
                ),
                atop: '0,
    ...
    always_comb begin
        ...
        if (w_cnt_q > '0) begin
            ...
            wr_meta_d = '{
                ...
                addr_t'(
                axi_pkg::aligned_addr(
                    axi_pkg::largest_addr_t'(axi_req_i.aw.addr), axi_req_i.aw.size
                )
                ),
...
<<<<<<< HEAD:hw/vendor/pulp_platform/axi/src/axi_to_detailed_mem.sv
    // Handle requests.
...
>>>>>>> origin/main:hw/vendor/x-heep/pulp_platform/axi/src/axi_to_detailed_mem.sv
