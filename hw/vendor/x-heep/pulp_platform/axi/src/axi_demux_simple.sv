...
<<<<<<< HEAD:hw/vendor/pulp_platform/axi/src/axi_demux_simple.sv
        end
...
>>>>>>> origin/main:hw/vendor/x-heep/pulp_platform/axi/src/axi_demux_simple.sv
        end
...
`ifndef XSIM
        ...
        ((w_open == '0) && (w_cnt_up ^ w_cnt_down) |-> !w_cnt_down))
